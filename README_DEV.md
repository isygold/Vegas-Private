...
| `vegas.telemetry` | string | off | `dxvk_options.h:98` | `dxvk_options.cpp:31`, `vegas.cpp:telemetryDrawsActive/telemetryFgActive` | Master logging switch: off / draws (draw-count CSV) / fg (FG-stats CSV) / all; legacy true/false = all/off |
